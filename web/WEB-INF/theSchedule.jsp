               ...
               <div class="main">
                    ...
                    <div class="rto">
                         ...
                         <c:if test="${fill ne null}">
                              <!--Form for filling up extra shifts -->
                              <h2>Fill</h2>
                              <table role="table">
                                   <thead role="rowgroup">
                                        <tr role="row">
                                             ...
                                             <c:forEach var="counter" begin="0" end="${shifts.size() - 1}" step="3" varStatus="i">
                                                  <tr role="row">
                                                       ...
                                                       <c:if test="${shifts.get(counter).getUser().getFirstName() eq 'Extender'}">
                                                            ...
                                                            <td role="cell"><c:out value="${shifts.get(counter).getUser().getFirstName()} ${shifts.get(counter).getUser().getLastName()}" />   
                                                                 <form action="theSchedule" method="post">
                                                            ...
                                                            <td role="cell"><c:out value="${shifts.get(counter + 1).getUser().getFirstName()} ${shifts.get(counter + 1).getUser().getLastName()}" /> 
                                                                 <form action="theSchedule" method="post">
                                                                      <input type="submit" name="edit" value="Edit">
                                                                      <input type="hidden" name="action" value="editUser">
                                                            ...
                                                            <td role="cell"><c:out value="${shifts.get(counter + 2).getUser().getFirstName()} ${shifts.get(counter + 2).getUser().getLastName()}" /> 
                                                                 <form action="theSchedule" method="post">
                                                                      <input type="submit" name="edit" value="Edit">
                                                                      <input type="hidden" name="action" value="editUser">
